...
export function MagneticText({
  ...
  return (
    ...
    >
      ...
      <span className={cn("text-foreground tracking-wide", textClassName || "text-5xl font-bold tracking-tighter")}>
        {text}
      </span>

      <div
        ref={circleRef}
        className={cn("absolute top-0 left-0 pointer-events-none rounded-full overflow-hidden", circleClassName || "bg-foreground")}
        style={{
      ...
      >
        ...
        >
          <span className={cn("text-background whitespace-nowrap tracking-wide", hoverTextClassName || "text-5xl font-bold tracking-tighter")}>
            {hoverText}
          </span>
        </div>
      </div>
